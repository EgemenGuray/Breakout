...
/** Loads sound clip */    
    ...
    private void breakoutGameCasual(){
    ...
    private void moveBall(){
        ball.move(vx, vy);
        if(brickNumber>(NBRICKS_PER_ROW*(NBRICK_ROWS-2))){
            pause(DELAY);
        }
        else if(brickNumber>(NBRICKS_PER_ROW*(NBRICK_ROWS-4))){
            pause(DELAY-1);
        }
        else if(brickNumber>(NBRICKS_PER_ROW*(NBRICK_ROWS-6))){
            pause(DELAY-2);
        }
        else if(brickNumber>(NBRICKS_PER_ROW*(NBRICK_ROWS-8))){
            pause(DELAY-3);
        }else{
            pause(DELAY-3);
        }
    ...
    private static int brickNumber = (NBRICKS_PER_ROW*NBRICK_ROWS);
    /*
    ...
    /*
     * Message that says you won the game
     */
    private void printcond1(){
        GLabel cond1 = new GLabel("You Won!!", getWidth()/2.0, getHeight()/2.0);
        cond1.move(-cond1.getWidth()/2.0, -cond1.getHeight());
        cond1.setColor(Color.RED);
        cond1.setFont("Helvetica-24");
        add(cond1);
    }
 
    /*
     * Message that says you lost
     */
    private void printcond2(){
        GLabel cond2 = new GLabel("Game Over You Lost!!!", getWidth()/2.0, getHeight()/2.0);
        cond2.move(-cond2.getWidth()/2.0-55, -cond2.getHeight());
        cond2.setFont("Helvetica-24");
        cond2.setColor(Color.RED);
        add(cond2);
    }       
